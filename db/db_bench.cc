...
class Benchmark {
 ...
 private:
  ...
  static void ThreadBody(void* v) {
    ...
    fprintf(stderr, "begin start thread\n");
    thread->stats.Start();
    (arg->bm->*(arg->method))(thread);
    fprintf(stderr, "before finish thread\n");
    thread->stats.Stop();
    fprintf(stderr, "after finish thread\n");
